...
public enum SuperstructureLocation {
    ...
    LEVEL3(18.5, 27, 74),
    LEVEL4(43.45, 33, 95),
    ALGAE_DESCORE2_3(28.5 - 4.5 - 1, 115 - 22, 42),
    ALGAE_DESCORE3_4(41.4 - 3.5 - 1, 115 - 22, 42),
    ALGAE_DESCORE2_3_LOW(26.5 - 4.5 - 1, 115 - 22, 42),
    ALGAE_DESCORE3_4_LOW(39.4 - 3.5 - 1, 115 - 22, 42),

    PRENET(19 + 3, 90, 228),
    NET(36 - 4, 22 - 3, 165),

    ALGAE_LEVEL_2_3(20.3 - 2, 114, 228), // -2 for UDM and worlds
    ALGAE_LEVEL_3_4(34.9 - 2, 114, 228),
