...
public class ClimbCommands {
    ...
    public static Command autoDriveClimb(RobotContainer r){
        SequentialCommandGroup sg = new SequentialCommandGroup(
            new ConditionalCommand(new NewPathFinder(r, () -> Locations.getCageLocation(r), false, true), new InstantCommand(), () -> checkIfPathfindNeeded(r)),
            new CmdDriveCageTraj(r),
            r.climb.setClimbVoltage(12),
            new WaitCommand(0.25),
            r.climb.setClimbVoltage(0),
            DriveCommands.joystickDriveFlysky(r).raceWith(new WaitUntilCommand(r.flysky.rightTriggerSWG)),
            r.climb.setClimbVoltage(12),
            new WaitCommand(3),
            r.climb.setClimbVoltage(0)
        );
