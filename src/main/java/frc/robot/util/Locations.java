...
public class Locations {
    ...
    static Transform2d halfRobotCoralLeft = new Transform2d(robotLength/2 + Units.inchesToMeters(4), Units.inchesToMeters(5), new Rotation2d());
    static Transform2d halfRobotCoralRight = new Transform2d(robotLength/2 + Units.inchesToMeters(4), Units.inchesToMeters(-5), new Rotation2d());
